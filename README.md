...
- 🌐 **HTML version (full output):**  
  👉 [Download and open the HTML report](report/potomac_analysis_report.html)  
  → GitHub cannot preview large HTML files. Download and open in your browser.

- 🧪 **Reproducible source (R Markdown):**  
  👉 [`analysis/potomac_analysis_report.Rmd`](analysis/potomac_analysis_report.Rmd)  
  → Contains the full code and analysis pipeline used to generate the report
